// code copied from https://godotshaders.com/shader/advanced-modulate/
// I just modified the ending so that the node's alpha/transparency will still apply (works with sprites and particles)
